...
import Moment from 'react-moment'
 ...
 class Lyrics extends Component {
    ...
    componentDidMount() {
        axios.get(`https://cors-anywhere.herokuapp.com/https://api.musixmatch.com/ws/1.1/track.lyrics.get?track_id=${this.props.match.params.id}&apikey=f5ea45c1c8fb098deb912574e46f2c10`)
        .then(res => {
            //console.log(res.data);
            this.setState({lyrics: res.data.message.body.lyrics});
            return axios.get(`https://cors-anywhere.herokuapp.com/https://api.musixmatch.com/ws/1.1/track.get?track_id=${this.props.match.params.id}&apikey=f5ea45c1c8fb098deb912574e46f2c10`)
        })
        .then(res => {
            //console.log(res.data)
